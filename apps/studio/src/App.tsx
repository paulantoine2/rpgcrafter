...
export default function App() {
  ...
  return <div className="isolate flex h-full min-h-0 bg-background text-foreground">
    <StudioAppSidebar
      ...
      assetManagerOpen={assetManagerDialog}
      ...
      onOpenAssetManager={() => setAssetManagerDialog(true)}
      onPlay={playGame}
    />
