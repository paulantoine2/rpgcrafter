import { autotileRecipe, autotileVariant, type TilesetDefinition } from '@rpgcrafter/game-schema';
...
export function TerrainPreview({ tileset, terrainId, imageUrl }: { tileset: TilesetDefinition; terrainId: string; imageUrl: string }) {
  ...
  const previewMask = 0;
  const variant = autotileVariant(tileset, previewMask, autotileRecipe(tileset, terrain));
